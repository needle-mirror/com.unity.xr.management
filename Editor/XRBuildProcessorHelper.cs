...
namespace UnityEditor.XR.Management
{
    ...
    public abstract class XRBuildHelper<T>  : IPreprocessBuildWithReport, IPostprocessBuildWithReport
        where T : UnityEngine.Object
    {
        ...
        {
            EditorBuildSettings.TryGetConfigObject(BuildSettingsKey, out UnityEngine.Object settingsObj);
            if (settingsObj == null || settingsObj is not T)
                return null;
        ...
        static void SetSettingsForRuntime(UnityEngine.Object settingsObj)
        {
